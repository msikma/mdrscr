...
exports.fetchMandarakeAuctionSearch = undefined;
...
var reCat = new RegExp('itemsListJa\\.html\\?category=(.+?)$');
...
var parseLink = function parseLink(url) {
  return '' + (!url.startsWith('http') ? _urls.MANDARAKE_AUCTION_PATH : '') + url;
};
 ...
 */
var fetchMandarakeAuctionSearch = exports.fetchMandarakeAuctionSearch = function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            entriesUnfiltered = $('#itemListLayout .block').map(parseSearchResult($)).get();
