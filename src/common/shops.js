...
export const COCOO = ['33', 'CoCoo', 'CoCoo']
export const SHIBUYA = ['6', 'Shibuya', '渋谷店']
export const IKEBUKURO = ['26', 'Rarara (Ikebukuro)', 'ラララ（池袋店）']
export const NAYUTA = ['32', 'Nayuta', '那由多']
export const NAGOYA = ['4', 'Nagoya', '名古屋店']
export const UTSUNOMIYA = ['28', 'Utsunomiya', '宇都宮店']
export const UMEDA = ['7', 'Umeda', 'うめだ店']
export const GRANDCHAOS = ['23', 'Grandchaos', 'グランドカオス']
